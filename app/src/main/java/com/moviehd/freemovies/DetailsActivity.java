...
import com.moviehd.freemovies.hdmovies_adapters.CastCrewAdapter;
import com.moviehd.freemovies.hdmovies_adapters.CommentsAdapter;
import com.moviehd.freemovies.hdmovies_adapters.EpisodeAdapter;
import com.moviehd.freemovies.hdmovies_adapters.DownloadAdapter;
import com.moviehd.freemovies.hdmovies_adapters.HomePageAdapter;
import com.moviehd.freemovies.hdmovies_adapters.LiveTvHomeAdapter;
import com.moviehd.freemovies.hdmovies_adapters.ProgramAdapter;
import com.moviehd.freemovies.hdmovies_adapters.ServerApater;
import com.moviehd.freemovies.hdmovies_database.DatabaseHelper;
import com.moviehd.freemovies.hdmovies_models.CastCrew;
import com.moviehd.freemovies.hdmovies_models.GetCommentsModel;
import com.moviehd.freemovies.hdmovies_models.CommonModels;
import com.moviehd.freemovies.hdmovies_models.EpiModel;
import com.moviehd.freemovies.hdmovies_models.PostCommentModel;
import com.moviehd.freemovies.hdmovies_models.Program;
import com.moviehd.freemovies.hdmovies_models.SubtitleModel;
import com.moviehd.freemovies.hdmovies_models.single_details.Cast;
import com.moviehd.freemovies.hdmovies_models.single_details.Director;
import com.moviehd.freemovies.hdmovies_models.single_details.DownloadLink;
import com.moviehd.freemovies.hdmovies_models.single_details.Episode;
import com.moviehd.freemovies.hdmovies_models.single_details.Genre;
import com.moviehd.freemovies.hdmovies_models.single_details.RelatedMovie;
import com.moviehd.freemovies.hdmovies_models.single_details.Season;
import com.moviehd.freemovies.hdmovies_models.single_details.SingleDetails;
import com.moviehd.freemovies.hdmovies_models.single_details.Subtitle;
import com.moviehd.freemovies.hdmovies_models.single_details.Video;
import com.moviehd.freemovies.hdmovies_network.RetrofitClient;
import com.moviehd.freemovies.hdmovies_network.apis.CommentApi;
import com.moviehd.freemovies.hdmovies_network.apis.FavouriteApi;
import com.moviehd.freemovies.hdmovies_network.apis.SingleDetailsApi;
import com.moviehd.freemovies.hdmovies_network.apis.SubscriptionApi;
import com.moviehd.freemovies.hdmovies_network.model.ActiveStatus;
import com.moviehd.freemovies.hdmovies_network.model.AdsConfig;
import com.moviehd.freemovies.hdmovies_network.model.FavoriteModel;
import com.moviehd.freemovies.hdmovies_service.DownloadWorkManager;
import com.moviehd.freemovies.hdmovies_utils.PreferenceUtils;
import com.moviehd.freemovies.hdmovies_utils.ApiResources;
import com.moviehd.freemovies.hdmovies_utils.ads.BannerAds;
import com.moviehd.freemovies.hdmovies_utils.Constants;
import com.moviehd.freemovies.hdmovies_utils.ads.PopUpAds;
import com.moviehd.freemovies.hdmovies_utils.ToastMsg;
import com.moviehd.freemovies.hdmovies_utils.Tools;
import com.moviehd.freemovies.hdmovies_utils.VolleySingleton;
...
//                    for (int e = 0 ; e>listSubtv.get())
    ...
    private void getActiveStatus(String userId) {
        ...
        Call<ActiveStatus> call = subscriptionApi.getActiveStatus(com.moviehd.freemovies.Config.API_KEY, userId);
